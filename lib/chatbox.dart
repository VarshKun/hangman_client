...
class ChatWindow extends State<Chat> with TickerProviderStateMixin {
  ...
  static final TextEditingController TextController =
      ...
      body: new Column(children: <Widget>[
        ...
        new Container(
          ...
          decoration: new BoxDecoration(
              color: Colors.white), //Color.fromRGBO(10, 94, 251, 0.8)),
        ),
      ]),
    );
  }
    ...
    return new IconTheme(
      data: new IconThemeData(
          color: Color.fromRGBO(
              10, 94, 251, 0.8)), //Theme.of(context).accentColor),
      child: new Container(
              ...
              new Flexible(
                child: new TextField(
                  ...
                  onSubmitted: (String txt) => {
                    _submitMsg(TextController.text, widget.avatarIndex,
                        widget.username),
                    _isWriting = false,
                    ChatWindow.TextController.text = txt,
                    //TextController.selection =
                    ...
                    ChatWindow.TextController.clear()
                  },
                  decoration: new InputDecoration.collapsed(
                      hintText: "Enter letter here"),
                ),
              ),
              new Container(
                  //starting_game.currentinstance.submitGuess(),
                          ...
                          onPressed: _isWriting
                              ? () => {
                                    _submitMsg(TextController.text,
                                        widget.avatarIndex, widget.username),
                                  }
                              : null)
                      : new IconButton(
